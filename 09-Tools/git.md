...
3. **rebase 叫做变基，也是把别的分支合到自己身上，但效果好像在基的基础上重新提交自己的多次 commit**。**在 future 上**，rebase master，master 不变，future 的提交被顶到最后，不会多出一个新的提交点。**注意，不要在 master 上 rebase future**，因为 rebase 后，master 上的多次提交会被顶到别的分支后面，相当于篡改了历史。
