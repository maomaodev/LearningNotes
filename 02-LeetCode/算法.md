...
1. 问题描述
   ...
   假设有n种物品：物品 i 的重量为 w<sub>i</sub>，价格为 v<sub>i</sub>，背包所能承受的最大重量为W，我们如何选择才能使得物品的总价格最高。有三种类型的背包问题，这里指的是0-1背包。类似题目还有[416. 分割等和子集](https://leetcode-cn.com/problems/partition-equal-subset-sum/)、[494. 目标和](https://leetcode-cn.com/problems/target-sum/)、[面试题 08.11. 硬币](https://leetcode-cn.com/problems/coin-lcci/)。
...
1. 两个整数 int 值的加法/乘法、整数取反等操作都可能导致其**越界错误**